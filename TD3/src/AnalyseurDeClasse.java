...
public class AnalyseurDeClasse {
    ...
    public static void afficheAttributs(Class cl) {
        ...
        for (int i=0; i<Attributes.length;i++){
             ...
             Annotation[] ann =Attributes[i].getDeclaredAnnotations();
             for (int j=0 ;i<ann.length;i++)
             {
                 System.out.println(ann[j].toString());
             }
    ...
    public static void afficheConstructeurs(Class cl) {
        ...
        for (int i=0 ;i<constructeur.length;i++ ) {
            ...
            Annotation[][] ann=constructeur[i].getParameterAnnotations();

            for (int j=0;j<ann.length;j++)
            {
                if (ann[j]!=null)
                {
                    for (int k=0;k<ann[j].length;k++)
                    {
                        System.out.println(ann[j][k].toString());
                    }
                }
    ...
    public static void afficheMethodes(Class cl) {
        ...
        for (int i=0 ;i<methods.length;i++ ) {
            ...
            Annotation[][] ann=methods[i].getParameterAnnotations();
