...
public class Exercice2b extends JDialog {
	...
	// le fait que ce champ doivent être partagé par toutes les instances de la classe Exercice2b nécessite qu'il soit statique
	// De ce fait il est possible que les classes internes Exercice2-* soient statiques ou pas (puisque un champ statique de la classe englobante 
	// peut être atteint par une classe interne statique ou pas)
