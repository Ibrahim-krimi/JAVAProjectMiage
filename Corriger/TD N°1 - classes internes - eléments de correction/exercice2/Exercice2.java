...
public class Exercice2 extends JDialog {
	...
	// le fait que ce champ soit propre à une instance de 
	// Exercice2 implique l'utilisation d'une classe non statique car une classe statique ne peut accéder qu'aux champs statiques
