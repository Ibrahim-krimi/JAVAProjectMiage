...
//		p.saveEtudiants("f_etudiant1");
		...
		for (Personne personne : p.personnes) {
			if (personne != null) {
				System.out.println ("personne: " + personne.getNom() + "  " + personne.getPrenom());
				if (personne.getAdresse() != null) {
					System.out.println("personne: " + personne.getAdresse().getNumero() + " " + personne.getAdresse().getRue() + " " + personne.getAdresse().getVille() + "(" + personne.getAdresse().isAdressePersonnelle() + ")");
				}
			}
		}
