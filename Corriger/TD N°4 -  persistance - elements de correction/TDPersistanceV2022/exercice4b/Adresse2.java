...
public class Adresse2 implements Externalizable {
	...
	public  Adresse2() {
		System.out.println("Constructeur par défaut de l'adresse2");
	}
	...
	public void writeExternal(java.io.ObjectOutput out)    
            throws IOException {
	   System.out.println("write external (adresse2 du 4b): ");
   ...
   public void readExternal(java.io.ObjectInput in)
	  ...
	  System.out.println("read external (adresse2 du 4b): ");
