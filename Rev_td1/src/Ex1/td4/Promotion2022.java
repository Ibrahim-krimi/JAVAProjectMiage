...
public void saveEtudiants( String nom)
{
    ObjectOutputStream g_etudiant;
    try {
         FileOutputStream support = new FileOutputStream(nom);
...
@SuppressWarnings("unchecked")
 void retrieveEtudiants(String nom)
{
    ObjectInputStream g_etudiant = null;
    try {
        FileInputStream support = new FileInputStream(nom);
...
/*
    System.out.println("Avant serialisation");
    p.init();
    p.initTableau();
    p.saveEtudiants("f_etudiant1");
 */
    p.retrieveEtudiants("f_etudiant1");
    System.out.println("apres deserialisation");
