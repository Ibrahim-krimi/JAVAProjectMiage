...
public class ModuleEnseignementStatique {
    public enum TypeExercice {QCM, projet, questionsSynthese}
    ...
    public static class ConsummerUE implements Consumer<ModuleEnseignementStatique>{
        ...
        public void accept(ModuleEnseignementStatique m) {
            System.out.println("le nom du module est :"+ m.getNomModule() +"et annee de creation "+m.getAnneeCreation());
            m.setAnneeCreation(m.getAnneeCreation()+1);
            System.out.println("le nom du module est :"+ m.getNomModule() +"et annee de modifier " +m.getAnneeCreation());
